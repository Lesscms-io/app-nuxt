...
import { useCollection } from '~/composables/useLessCMS'
import { useLanguage } from '~/composables/useLanguage'
import { useApi } from '~/composables/useLessCMS'
...
import type { CollectionEntry, CollectionTemplate, TemplateSection } from '~/types/api'
